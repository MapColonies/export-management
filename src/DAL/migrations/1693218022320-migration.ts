...
export class Migration1693218022320 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "export_manager"."task_geometry" ("id" SERIAL NOT NULL, "wkt_geometry" text, "metadata" jsonb, CONSTRAINT "PK_272fcc66b7ee91809977624b51a" PRIMARY KEY ("id"))`);
