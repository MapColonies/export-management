...
export class Migration1709118770200 implements MigrationInterface {
    name = 'Migration1709118770200'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "export_manager"."task_geometry" ("id" SERIAL NOT NULL, "geom" geometry NOT NULL, "metadata" jsonb, CONSTRAINT "PK_272fcc66b7ee91809977624b51a" PRIMARY KEY ("id"))`);
